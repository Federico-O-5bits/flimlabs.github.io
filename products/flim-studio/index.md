...
To manually specify clusters on the phasor plot, click the green '+'     <img src="../../assets/flim-studio/button-add.PNG" alt="phasor plot and GMM settings" width='22px' height='22px'>
