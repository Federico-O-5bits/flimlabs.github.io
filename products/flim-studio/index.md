...
To manually specify clusters on the phasor plot, click the green '+' then move your cursor over the phasor plot and place the cluster in the region of your choiche. Multiple clusters can be added to the phasor plot.    
You can relocate a cluster by clicking its center and dragging it to a new position, then clicking again to set it.  
Below the green '+'  <img src="../../assets/flim-studio/button-add.PNG" width='22px' height='21.6px' alt="add circlet button">button is a table displaying cluster information:  
