...
| <span id='number-of-pixel'>Number of pixel on x/y line</span>         | Set the same value as made in Box width/Box height. <br>Starting from the top-left corner of the Box choose the number of pixels along the X and Y axes from which to retrieve data. <br>The maximum value is determined by the value set in the 'Box Width/Height' input field. <br> <img src="../../assets/flim-studio/gif-box-frame.gif" alt="frame box settings gif">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
