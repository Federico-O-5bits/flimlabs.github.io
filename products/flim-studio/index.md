...
To manually specify clusters on the phasor plot, click the green '+'<img src="../../assets/flim-studio/button-add.PNG" alt="phasor plot and GMM settings" style="position: relative; top: 4px;" width="22px" height="22px"> button then move your cursor over the phasor plot and place the cluster in the region of your choiche. Multiple clusters can be added to the phasor plot.    
